...
let url_be_root4 =  if (local) "http://localhost:4666" else "http://ec2-54-246-215-40.eu-west-1.compute.amazonaws.com:4666"
let url_be_create4 =  url_be_root ++ "/creatememe";
